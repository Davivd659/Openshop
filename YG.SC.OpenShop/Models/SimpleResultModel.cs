...
namespace YG.SC.OpenShop
{
    ...
    public class SimpleResultModel
    {
        ...
        public static SimpleResultModel Conclude(System.Enum status)
        {
    ...
    public class IntResultModel : ResultModel<int>
    {
        ...
        public new static IntResultModel Conclude(System.Enum status)
        {
            return Conclude(status, 0);
        }

        public new static IntResultModel Conclude(System.Enum status, int result)
        {
            var enumItem = EnumExtenstion.GetEnumItem(status.GetType(), status);
    ...
    public class ResultModel<TResult>
    {
        ...
        public static ResultModel<TResult> Conclude(System.Enum status)
        {
            return Conclude(status, default(TResult));
        }

        public static ResultModel<TResult> Conclude(System.Enum status, TResult result)
        {
            var enumItem = EnumExtenstion.GetEnumItem(status.GetType(), status);
