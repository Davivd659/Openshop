...
------初始账户
--INSERT ScmUser(UserName,LoginName,Password,UserPhone,UserCd,SourceCd,InsBy,InsDt,UpdBy,UpdDt,Recsts) VALUES('test123用户','test123','123456','','SENIOR','WEB','SYSTEM',GETDATE(),'SYSTEM',GETDATE(),'0')
--INSERT ScmUser(UserName,LoginName,Password,UserPhone,UserCd,SourceCd,InsBy,InsDt,UpdBy,UpdDt,Recsts)  VALUES('admin用户','admin123','123456','','SENIOR','WEB','SYSTEM',GETDATE(),'SYSTEM',GETDATE(),'0')
