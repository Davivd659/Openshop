...
namespace YG.SC.WebAPIService.Filters
{
    ...
    public class YgScCacheOutputAttribute : CacheOutputAttribute, IActionFilter
    {
        ...
        private void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            var mediaType = _webApiCache.Get(cachekey + Constants.ContentTypeKey);
            var contenttype = mediaType == null ? DefaultMediaType : new MediaTypeHeaderValue(mediaType.ToString()) { CharSet = Encoding.UTF8.HeaderName };
